...
export default function Navbar() {
  return (
    <nav
      className="bg-NAVBAR_COLOR text-white w-full top-0 z-10 flex items-center justify-between h-24 px-4 relative"
      id="navbar"
    >
      ...
      <div className="absolute left-1/2 bottom-2 transform -translate-x-1/2 flex flex-col items-center  sm:left-24 max-sm:text-center">
